    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('email_code', models.CharField(blank=True, max_length=10, null=True)),
                ...
                ('role', models.CharField(choices=[('USER', 'user'), ('TEACHER', 'teachers'), ('ADMIN', 'admin')], default='USER', max_length=10)),
